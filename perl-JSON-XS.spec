...
Source0  : https://cpan.metacpan.org/authors/id/M/ML/MLEHMANN/JSON-XS-4.02.tar.gz
Summary  : unknown
Group    : Development/Tools
License  : Artistic-1.0 GPL-1.0
Requires: perl-JSON-XS-bin = %{version}-%{release}
Requires: perl-JSON-XS-lib = %{version}-%{release}
...
JSON::XS - æ­£ããã¦é«éãª JSON ã·ãªã¢ã©ã¤ã¶/ãã·ãªã¢ã©ã¤ã¶
...
%package lib
Summary: lib components for the perl-JSON-XS package.
Group: Libraries
Requires: perl-JSON-XS-license = %{version}-%{release}

%description lib
lib components for the perl-JSON-XS package.
...
cp COPYING %{buildroot}/usr/share/package-licenses/perl-JSON-XS/COPYING
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.28.2/x86_64-linux-thread-multi/JSON/XS.pm
/usr/lib/perl5/vendor_perl/5.28.2/x86_64-linux-thread-multi/JSON/XS/Boolean.pm
...
%files lib
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.28.2/x86_64-linux-thread-multi/auto/JSON/XS/XS.so

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/perl-JSON-XS/COPYING
