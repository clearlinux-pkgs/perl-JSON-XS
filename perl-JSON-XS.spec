...
cp %{_builddir}/JSON-XS-4.02/COPYING %{buildroot}/usr/share/package-licenses/perl-JSON-XS/9a56f3b919dfc8fced3803e165a2e38de62646e5
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.1/x86_64-linux-thread-multi/JSON/XS.pm
/usr/lib/perl5/vendor_perl/5.30.1/x86_64-linux-thread-multi/JSON/XS/Boolean.pm
/usr/lib/perl5/vendor_perl/5.30.1/x86_64-linux-thread-multi/auto/JSON/XS/XS.so
